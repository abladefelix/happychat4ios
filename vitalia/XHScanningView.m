...
#define kXHQRCodeRectPaddingX 50
...
- (UIImageView *)scanningImageView {
    if (!_scanningImageView) {
        _scanningImageView = [[UIImageView alloc] initWithFrame:CGRectMake(kXHQRCodeRectPaddingX, 60, CGRectGetWidth(self.bounds) - kXHQRCodeRectPaddingX*2, 3)];
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.clearRect = CGRectMake(kXHQRCodeRectPaddingX, 60, CGRectGetWidth(frame) - kXHQRCodeRectPaddingX * 2, CGRectGetWidth(frame) - kXHQRCodeRectPaddingX * 2);
...
- (void)drawRect:(CGRect)rect {
    ...
    switch (self.scanningStyle) {
        case XHScanningStyleQRCode: {
            ...
            clearRect = CGRectMake(paddingX, 60, CGRectGetWidth(rect) - paddingX * 2, CGRectGetWidth(rect) - paddingX * 2);
            break;
        }
