...
- (void)viewDidLoad {
    ...
    //创建一个导航栏
//    UINavigationBar *navigationBar = [[UINavigationBar alloc] initWithFrame:CGRectMake(0,0, 320, 44+statusBarHeight)];
...
//    [self.view addSubview:navigationBar];
    ...
    search.frame=CGRectMake(0, 44+statusBarHeight, screenframe.size.width, 44);
    [self.view addSubview:search];
    
    //添加table
    table=[[UITableView alloc] initWithFrame:CGRectMake(0, 88+statusBarHeight, screenframe.size.width, self.view.bounds.size.height-(88+statusBarHeight)) style:UITableViewStylePlain];
