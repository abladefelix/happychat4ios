...
+(NSString *)admUUID
{
    NSString * uuid = [SSKeychain passwordForService: @"com.vikaa.hellowechat" account: @"userid"];
    if (uuid) {
        return uuid;
    }
    ...
    [SSKeychain setPassword: result forService: @"com.vikaa.hellowechat" account: @"userid"];
    return result;
}
