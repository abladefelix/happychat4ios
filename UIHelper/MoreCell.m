...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])
    {
        ...
        loadingLabel = [[UILabel alloc] initWithFrame:CGRectMake(60.0/320*screenframe.size.width, 10, 200.0/320*screenframe.size.width, 21)];
        ...
        [loadingIndicator setFrame:CGRectMake(220.0/320*screenframe.size.width, 10, 25, 25)];
